  ...
  return (
    <>
      ...
      <div className="grid grid-cols-5 gap-1 sm:gap-1 md:gap-2 lg:gap-2 xl:gap-2 2xl:gap-2 mx-6 sm:mx-40 md:mx-50 lg:mx-60 xl:mx-70 2xl:mx-80 mt-5 mb-5 p-2 justify-center justify-items-center">
        <div className="p-2 sm:p-3 size-10 sm:size-12 rounded-[10px] border-[1px] bg-white border-[#dfdfdf] hover:scale-105 transition-transform duration-300 ease-in-out flex-auto">
        ...
        <div className="p-2 sm:p-3 size-10 sm:size-12 rounded-[10px] border-[1px] bg-white border-[#dfdfdf] hover:scale-105 transition-transform duration-300 ease-in-out flex-auto">
          <a href="https://atharv-rem.medium.com" target="_blank" rel="noreferrer">
